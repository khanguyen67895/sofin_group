...
export default function CoreValuesPage() {
  ...
  return (
    <>
      {/* Hero */}
      <section className="relative pt-18 pb-2 md:pt-40 px-5 sm:px-10 md:px-20 lg:px-30 text-center">
        <img
          src={icBannerVct}
          alt=""
        ...
        <motion.p
          ...
          className="relative md:mt-4 text-text-neutral-normal text-sm md:text-base font-['Mona_Sans'] mx-auto leading-6"
        >
