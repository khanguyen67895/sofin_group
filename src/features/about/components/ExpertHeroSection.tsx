...
export default function ExpertHeroSection() {
  return (
    <section className="relative pb-0 overflow-hidden">
      ...
      <div className="relative z-20 text-center px-5 pb-4 md:pb-14">
        <img
          src={icBannerVct}
          alt=""
      ...
      <div className="relative mx-auto max-w-7xl px-5 md:px-10">
        ...
        {stats.map((s, i) => (
          ...
          >
            <div
              className="flex flex-col items-center justify-center px-3 py-3 md:px-6 md:py-4 rounded-xl"
              style={{ background: '#0C0C0C' }}
            >
              <p className="text-primary-500 text-2xl md:text-5xl font-semibold font-['Unbounded'] leading-none">
                {s.value}
              </p>
              <p className="text-neutral-100 text-[7px] md:text-[11px] font-['Mona_Sans'] mt-1 tracking-widest uppercase text-center">
                {s.label}
              </p>
            </div>
          </motion.div>
