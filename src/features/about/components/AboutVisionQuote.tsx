...
export default function AboutVisionQuote() {
  return (
    <section className="w-full py-15 md:py-20 bg-[radial-gradient(ellipse_50%_50%_at_50%_0%,#242424_0%,rgba(15,15,15,0)_100%),radial-gradient(ellipse_50%_50%_at_50%_100%,#242424_0%,rgba(15,15,15,0)_100%)] border-t-2 border-b-2 border-stone-950 inline-flex justify-center items-center gap-8">
