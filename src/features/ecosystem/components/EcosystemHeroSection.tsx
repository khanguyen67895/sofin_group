...
export default function EcosystemHeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 top-0 flex flex-col items-center text-center px-5 pt-20 md:pt-40" style={{ zIndex: 20 }}>
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.7, ease: 'easeOut' }}
        >
          <h1 className="justify-center text-text-neutral-normal px-4 md:p-0 text-2xl md:text-6xl font-semibold font-['Unbounded'] md:leading-18">
